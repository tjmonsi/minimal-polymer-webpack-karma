...
var AppShell = function (_Polymer$Element) {
  _inherits(AppShell, _Polymer$Element);
...
var RegisterHtmlTemplate = __webpack_require__(16);

RegisterHtmlTemplate.register("<dom-module id=app-shell> <template> {{test}} </template> </dom-module>");
